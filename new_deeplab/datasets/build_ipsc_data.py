...
class IPSCInfo:
    class DBSplits:
        def __init__(self):
            ...
            self.frame_101_150 = irange(0, 2)
            self.frame_150_200 = irange(3, 5)
            self.frame_201_250 = irange(6, 13)
            self.frame_251_end = irange(14, 19)
            self.frame_150_end = self.frame_150_200 + self.frame_201_250 + self.frame_251_end
            self.frame_200_end = self.frame_201_250 + self.frame_251_end
